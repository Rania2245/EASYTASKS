...
import tn.itdevspace.easytask.repository.RessourceRepository;
...
class RessourceResourceIT {
    ...
    void getAllRessources() throws Exception {
        ...
        restRessourceMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(ressource.getId().toString())))
    ...
    void getRessource() throws Exception {
        ...
        restRessourceMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(ressource.getId().toString()))
    ...
    void getNonExistingRessource() throws Exception {
        // Get the ressource
        restRessourceMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteRessource() throws Exception {
        ...
        restRessourceMockMvc
            .perform(delete(ENTITY_API_URL_ID, ressource.getId().toString()).accept(MediaType.APPLICATION_JSON))
