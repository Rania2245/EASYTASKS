...
class MaintenanceResourceIT {
    ...
    void getAllMaintenances() throws Exception {
        ...
        restMaintenanceMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(maintenance.getId().toString())))
    ...
    void getMaintenance() throws Exception {
        ...
        restMaintenanceMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(maintenance.getId().toString()))
    ...
    void getNonExistingMaintenance() throws Exception {
        // Get the maintenance
        restMaintenanceMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteMaintenance() throws Exception {
        ...
        restMaintenanceMockMvc
            .perform(delete(ENTITY_API_URL_ID, maintenance.getId().toString()).accept(MediaType.APPLICATION_JSON))
