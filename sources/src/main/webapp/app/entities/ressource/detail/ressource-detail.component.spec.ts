...
describe('Ressource Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ ressource: { id: '9fec3727-3421-4967-b213-ba36557ca194' } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load ressource on init', () => {
      ...
      // THEN
      expect(comp.ressource).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
